...
//your code goes here
assert("monkey" > "giraffe");
assert("monkey" === "giraffe", "Assertion Failure, because a monkey is not" +
" a giraffe :) javascript compares them using lexagraphical order so m" +
" does not equal g");
...
// loop through array each time dividing total meals to that point by index+1
var add = 0;
var avg = 0;
...
/*
same as before but assign index+1 then break out of loop when average dips
below. i assume there is a better way to do this, but this works.
*/
var add2 = 0;
var avg2 = 0;
for (var i = 0; i < mealsPerDay.length; i++) {
 ...
 console.log("Lion eats caretaker on day " + tooHungryDay);
